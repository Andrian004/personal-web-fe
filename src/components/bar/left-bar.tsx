...
export function LeftBar() {
  return (
    <div className="w-full flex flex-col items-center gap-y-6 bg-white/70 backdrop-blur-lg rounded-2xl p-4">
      ...
      <div className="w-full bg-neutral-400/30 space-y-2 p-2 rounded-xl">
        <ContactCard
